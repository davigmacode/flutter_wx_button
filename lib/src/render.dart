...
class WxButtonRender extends StatefulWidget {
  ...
  /// The [WxButtonThemeData] that provides fallback values.
  /// {@endtemplate}
  final WxButtonThemeData theme;
...
class WxButtonRenderState extends State<WxButtonRender>
  ...
  @protected
  void setStyle() {
    final fromProps = WxButtonStyle(
      variant: widget.variant,
      severity: widget.severity,
    );
    final raw = fromProps.merge(widget.style);
    final specs = WxDrivenButtonStyle.evaluate(raw, widgetEvents.value);
